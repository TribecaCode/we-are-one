...
import Jerusalem from "./logos/Jerusalem-revised.png";
...
import Mumbai from "./logos/Mumbai-revised.png";
...
const Footer = () => (
  <div className="footer text-center">
    ...
    <p className="hind-text ">
      An unprecedented 10-day digital film festival exclusively on YouTube
      curated by the following film festivals
    </p>

    <div className="festivals">
      <a
        href="https://www.annecy.org/home"
        target="_blank"
      ...
      <a
        href="https://ficg.mx/35/public/es/home"
        target="_blank"
        rel="noopener noreferrer"
      >
      ...
      <a
        href="https://www.locarnofestival.ch/pardo/festival-del-film-locarno/home.html"
        target="_blank"
        rel="noopener noreferrer"
      >
      ...
      <a
        href="https://www.iffamacao.com/"
        target="_blank"
        rel="noopener noreferrer"
      >
        <img
          src={Macao}
          alt="International Film Festival & Awards Macao (IFFAM)"
        />
      </a>
      <a
        href="http://www.festivalmarrakech.info/"
        target="_blank"
        rel="noopener noreferrer"
      >
      ...
      <a
        href="https://www.mumbaifilmfestival.com/"
        target="_blank"
        rel="noopener noreferrer"
      >
      ...
      <a
        href="https://www.sansebastianfestival.com/"
        target="_blank"
        rel="noopener noreferrer"
      >
        <img
          src={SanSebastian}
          alt="San Sebastian International Film Festival"
        />
      </a>
      ...
      <a
        href="https://www.tribecafilm.com/"
        target="_blank"
        rel="noopener noreferrer"
      >
